/**
 * `prof map <topic>` — the field-mapping pipeline.
 *
 * Pipeline:
 ...
 *
 * Output: ~/.prof/notes/fields/<slug>/{overview.md, reading-order.md, subfields.md}
 */
...
---
_Generated by \`prof map "${topic}"\`. Reorder as you learn more._
`;
}
